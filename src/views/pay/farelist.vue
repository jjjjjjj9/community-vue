<template>
    <div>
        ...
        <el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" :header-cell-style="headStyle"
            ...
            <el-table-column prop="atitle" label="标题" align="center" width="160"></el-table-column>
            <el-table-column prop="title" label="车库名称" align="center" width="140"></el-table-column>
            <el-table-column prop="region" label="区域" align="center" width="80"></el-table-column>
            <el-table-column prop="name" label="车位号" align="center" width="100"></el-table-column>
            <el-table-column prop="area" label="车位面积" align="center" width="120"></el-table-column>
...
import { BillJiao, BillDel, Billchelist,Billbohui } from "../../api/userMG";
export default {
    data() {
        return {
