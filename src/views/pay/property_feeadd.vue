        ...
        <div class="demo-drawer__content">
          <el-row :gutter="20">
            <el-form label-width="110px" :model="editForm" ref="editForm">
              ...
              <el-col :span="12">
                <el-col class="titleq" style="margin-bottom: 20px">房屋信息</el-col>
                <div class="grid-content bg-purple">
                  <el-form-item label="选择房屋：" prop="name" label-width="140px">
...
import { HousexlList,BillEdit } from "../../api/userMG";
export default {
    data() {
        return {
            tableData:[],
