<template>
    ...
    <div>
      <el-card class="box-card box-cards">
        <el-row>
          <el-form :inline="true" class="user-search">
            <el-col :span="24">
              <el-form-item>
                <div class="card_top"><span>资讯内容</span></div>
              </el-form-item>
      ...
      <el-card class="box-card box-cards2">
        ...
        <el-table border stripe ref="multipleTable" :data="tableData" tooltip-effect="dark"
          ...
          <el-table-column prop="logo" label="封面图" align="center" width="300">
            <template slot-scope="scope">
              <img :src="scope.row.ioc" alt="" style="width:200px; height: 50px;">
            </template>
          </el-table-column>
          <el-table-column prop="title" label="标题" align="center"></el-table-column>
          <el-table-column prop="name" label="资讯分类" align="center"></el-table-column>
  
          <el-table-column prop="ctime" label="发布时间" align="center">
            <template slot-scope="scope">
              ...
              <el-col :span="22">
                <div class="grid-content bg-purple">
                  ...
                  <el-form-item label="资讯分类：" prop="name">
                      <el-select v-model="editForm.info_class_id" placeholder="请选择">
  ...
  import {
    Infoadd, InfoList, Infodel,InfoClassxllist
  } from "../../api/userMG";
