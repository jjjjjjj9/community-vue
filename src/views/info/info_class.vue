      ...
      <el-card class="box-card box-cards">
        <el-row>
          <el-form :inline="true" class="user-search">
            <el-col :span="24">
              <el-form-item>
                <div class="card_top"><span>资讯分类</span></div>
              </el-form-item>
                <el-form-item>
                    ...
                    <el-form label-width="110px" :model="editForm" :rules="rules" ref="editForm">
                        ...
                        <el-col :span="22">
                            <div class="grid-content bg-purple">
                                <el-form-item label="分类名称：" prop="password">
                                    <el-input v-model="editForm.title"></el-input>
                                </el-form-item>
                                <el-form-item label="是否启用：" prop="name">
                                    <el-select v-model="editForm.lx" placeholder="请选择">
...
import { InfoClassDel, InfoClassEdit, InfoClassList } from "../../api/userMG";
export default {
    data() {
        return {
            options: [{
