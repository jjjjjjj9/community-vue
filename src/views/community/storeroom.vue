    ...
    <div>
        <el-card class="box-card box-cards">
            <el-row>
                <el-form :inline="true" class="user-search">
                    <el-col :span="24">
                        <el-form-item>
                            <div class="card_top"><span>储藏室管理</span></div>
                        </el-form-item>
        ...
        <el-card class="box-card box-cards2">
            ...
            <el-table border ref="multipleTable" :data="tableData" :header-cell-style="headStyle" tooltip-effect="dark"
                ...
                <el-table-column prop="name" label="储藏室号" align="center"></el-table-column>
                    ...
                    <el-form label-width="110px" :model="editForm" :rules="rules" ref="editForm">
                        ...
                        <el-col :span="22">
                            <div class="grid-content bg-purple">
                                ...
                                <el-form-item label="储藏室编号：" prop="name">
...
import { Buildingxllist, StoreroomEdit, HouseStoreroomDelDel, StoreroomList } from "../../api/userMG";
export default {
    data() {
        return {
            options: [],
