    ...
    <div>
        <el-card class="box-card box-cards">
            <el-row>
                <el-form :inline="true" class="user-search">
                    <el-col :span="24">
                        <el-form-item>
                            <div class="card_top"><span>房屋管理</span></div>
                        </el-form-item>
        ...
        <el-card class="box-card box-cards2">
            ...
            <el-table border ref="multipleTable" :data="tableData" :header-cell-style="headStyle" tooltip-effect="dark"
                ...
                <el-table-column prop="name" label="房间号" align="center"></el-table-column>
                ...
                <el-table-column prop="garea" label="公摊面积" align="center"></el-table-column>
                <el-table-column prop="house_type" label="房屋户型" align="center"></el-table-column>
                <el-table-column prop="orientation" label="房屋朝向" align="center"></el-table-column>
                <el-table-column prop="building_type" label="房屋类型" align="center"></el-table-column>
                        ...
                        <el-col :span="22">
                            <div class="grid-content bg-purple">
                                <el-form-item label="楼栋名称：" prop="buildingid">
                                    <el-select v-model="editForm.buildingid" filterable placeholder="请选择" @change="xhuang($event)">
                                        <el-option
                                ...
                                <el-form-item label="单元数：" prop="unit">
                                    <el-input v-model="editForm.unit" type="number" :min="1" :max="max" placeholder="请输入单元数"></el-input>
                                </el-form-item>
                                <el-form-item label="房间号：" prop="name">
                                    <el-input v-model="editForm.name" placeholder="请输入房间号" ></el-input>
                                </el-form-item>
                                ...
                                <el-form-item label="公摊面积：" prop="garea">
                                    <el-input v-model="editForm.garea" placeholder="请输入公摊面积" ></el-input>
                                </el-form-item>
                                <el-form-item label="房屋户型：" prop="house_type">
                                    <el-input v-model="editForm.house_type" placeholder="请输入房屋户型" ></el-input>
                                </el-form-item>
                                
                                <el-form-item label="房屋朝向：" prop="orientation">
                                    <el-input v-model="editForm.orientation" placeholder="请输入房屋朝向" ></el-input>
                                </el-form-item>
                                <el-form-item label="房屋类型：" prop="building_type">
                                    <!-- <el-input v-model="editForm.building_type" placeholder="请输入房屋类型" ></el-input> -->
                                    <el-select v-model="editForm.building_type" placeholder="请选择房屋类型">
                                        <el-option
...
import { Buildingxllist, HouseEdit, HouseDel, HouseList } from "../../api/userMG";
export default {
    data() {
        return {
            options: [],
