    ...
    <div>
        <el-card class="box-card box-cards">
            <el-row>
                <el-form :inline="true" class="user-search">
                    <el-col :span="24">
                        <el-form-item>
                            <div class="card_top"><span>车辆管理</span></div>
                        </el-form-item>
                        <el-form-item label="搜索：">
                            <el-input size="small" v-model="formInline.name" placeholder="输入车牌号或姓名"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-button size="small" type="goon" icon="el-icon-search" @click="search">搜索</el-button>
                        </el-form-item>
                        <el-form-item>
                            <el-button size="small" type="goon" icon="el-icon-search" @click="handleEdit()">添加</el-button>
                        </el-form-item>
                    </el-col>
                </el-form>
            </el-row>
        ...
        <el-card class="box-card box-cards2">
            ...
            <el-table border ref="multipleTable" :data="tableData" :header-cell-style="headStyle" tooltip-effect="dark"
                ...
                <el-table-column prop="hao" label="车牌号" align="center" width="100"> </el-table-column>
                <el-table-column prop="name" label="业主姓名" align="center" width="120"></el-table-column>
                    ...
                    <el-form label-width="110px" :model="editForm" :rules="rules" ref="editForm">
                        ...
                        <el-col :span="22">
                            <div class="grid-content bg-purple">
                                ...
                                <el-form-item label="车牌号：" prop="unit">
                                    <el-input v-model="editForm.hao"  placeholder="请输入车牌号"></el-input>
                                </el-form-item>
                                <el-form-item label="姓名：" prop="unit" v-if="editForm.idzh==0">
                                    <el-input v-model="editForm.name"  placeholder="请输入姓名"></el-input>
                                </el-form-item>
                                <el-form-item label="身份证号：" prop="unit" v-if="editForm.idzh==0">
...
import { OwnerVehicleAmountEdit, OwnerVehicleAmountList,OwnerMemberUserList,OwnerVehicleAmountdel } from "../../api/userMG";
export default {
    data() {
        return {
            arr:[],
    ...
    methods: {
        ...
        userlist(parameter) {
            this.loading = true;
            OwnerVehicleAmountList(parameter)
                .then((res) => {
                    this.loading = false;
        ...
        submitForm(info) {
            this.loading2 = true;
            debounce(() => {//防抖事件
                OwnerVehicleAmountEdit(this.editForm)
                    .then(res => {
         ...
         handleEditdel(index, row) {
            this.$confirm("确定要删除吗?", "信息", {
                ...
                .then(() => {
                    OwnerVehicleAmountdel({ id: row.id }) //删除
                        .then((res) => {
                            // console.log("d", res);
                            if (res.code == 200) {
                                this.$message({
